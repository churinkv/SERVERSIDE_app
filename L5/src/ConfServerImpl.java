...
// Получение соединения с БД
            Connection con = DriverManager.getConnection(
                    "jdbc:derby://localhost:1527/Lab05;create=true;user=root;password=toor"); // указать правильные значения
...
// Указание расположения классов RMI
            System.setProperty("java.rmi.server.codebase",
                    "file:///c:\\Users\\root\\Projects\\production\\Lab5\\"); // изменить путь
